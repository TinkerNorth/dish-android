...
internal fun buildHidDescriptor(): ByteArray =
    byteArrayOf(
        ...
        0x81.toByte(), 0x02, //   Input (Variable)
        ...
        0x81.toByte(), 0x42, //   Input (Variable, Null State)
        // 4-bit padding
        0x75, 0x04,
        0x95.toByte(), 0x01,
        0x81.toByte(), 0x03,
        ...
        0x09, 0xC5.toByte(), //   Usage (Brake / Left Trigger)
        0x09, 0xC4.toByte(), //   Usage (Accelerator / Right Trigger)
        0x15, 0x00,
