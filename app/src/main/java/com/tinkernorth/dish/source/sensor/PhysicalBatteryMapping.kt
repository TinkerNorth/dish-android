 ...
 * [BatteryValidator]. The caller ([PhysicalBatterySource]) is responsible for
...
object PhysicalBatteryMapping {
    ...
    // These differ from the wire STATUS_* in BatteryValidator; the whole job
     ...
     *    [BatteryValidator.LEVEL_UNKNOWN] sentinel rather than discarding it.
